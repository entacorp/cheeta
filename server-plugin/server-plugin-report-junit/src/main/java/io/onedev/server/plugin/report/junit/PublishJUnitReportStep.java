...
public class PublishJUnitReportStep extends PublishUnitTestReportStep {
	...
	@Editable(order=100, description="Specify JUnit test result file in XML format relative to <a href='https://docs.cheeta.io/concepts#job-workspace'>job workspace</a>, "
