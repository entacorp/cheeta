...
import static io.cheeta.server.plugin.report.unittest.UnitTestReport.CATEGORY;
	...
	protected void configure() {
		...
		contribute(ProjectMenuContribution.class, new ProjectMenuContribution() {
			...
			public List<SidebarMenuItem> getMenuItems(Project project) {
				...
				if (!Cheeta.getInstance(BuildMetricService.class).getAccessibleReportNames(project, UnitTestMetric.class).isEmpty()) {
