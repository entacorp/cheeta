...
public class ImportOption implements Serializable {
	...
	@Editable(order=200, description="Specify how to map YouTrack issue state to Cheeta issue state. "
			+ "Unmapped states will use the initial state in Cheeta.<br>"
	...
	@Editable(order=300, description="Specify how to map YouTrack issue fields to Cheeta. Unmapped fields will "
			...
			+ "<li>You may customize Cheeta issue fields in case there is no appropriate option here"
			+ "</ul>")
	...
	@Editable(order=300, description="Specify how to map YouTrack issue tags to Cheeta issue custom "
			+ "fields.<br>"
	...
	@Editable(order=400, description="Specify how to map YouTrack issue links to Cheeta issue links.<br>"
			+ "<b>NOTE: </b> You may customize Cheeta issue links in case there is no appropriate option here")
