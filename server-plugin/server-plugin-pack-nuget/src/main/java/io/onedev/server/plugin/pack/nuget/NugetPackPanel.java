...
public class NugetPackPanel extends GenericPanel<Pack> {
	...
	protected void onInitialize() {
		...
		add(new Label("addSource", "$ dotnet nuget add source --name cheeta --username <cheeta_account_name> --password <cheeta_password_or_access_token> --store-password-in-clear-text " + registryUrl));
