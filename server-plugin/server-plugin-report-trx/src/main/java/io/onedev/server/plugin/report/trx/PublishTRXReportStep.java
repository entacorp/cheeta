...
@Editable(order=10000, group=StepGroup.PUBLISH, name="TRX Report (.net unit test)")
public class PublishTRXReportStep extends PublishUnitTestReportStep {

	private static final long serialVersionUID = 1L;

	@Editable(order=100, description="Specify .net TRX test result file relative to <a href='https://docs.cheeta.io/concepts#job-workspace'>job workspace</a>, "
