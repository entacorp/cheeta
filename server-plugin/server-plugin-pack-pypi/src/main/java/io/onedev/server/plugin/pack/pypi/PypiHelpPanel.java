		...
		add(new CodeSnippetPanel("addRepository", new AbstractReadOnlyModel<>() {
			...
			public String getObject() {
				return "" +
						...
						"username=<cheeta_account_name>\n" +
						"password=<cheeta_account_password>";
			}
			
		}));
		
		add(new CodeSnippetPanel("uploadCommand", Model.of("$ python3 -m twine upload --repository cheeta /path/to/files_to_upload")));
