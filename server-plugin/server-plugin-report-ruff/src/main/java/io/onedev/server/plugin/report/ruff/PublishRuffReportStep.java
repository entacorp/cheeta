package io.cheeta.server.plugin.report.ruff;
...
public class PublishRuffReportStep extends PublishProblemReportStep {
	...
	@Editable(order=100, description="Specify ruff json result file relative to <a href='https://docs.cheeta.io/concepts#job-workspace'>job workspace</a>. "
