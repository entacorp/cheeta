...
public class IgnoredByUserCriteria extends Criteria<Issue> {
	...
	public Predicate getPredicate(@Nullable ProjectScope projectScope, CriteriaQuery<?> query, From<Issue, Issue> from, CriteriaBuilder builder) {
		...
		watchQuery.where(builder.and(
				...
				builder.equal(watch.get(IssueWatch.PROP_WATCHING), false));
	...
	public String toStringWithoutParens() {
		return IssueQuery.getRuleName(IssueQueryLexer.IgnoredBy) + " " + quote(user.getName());
	}
