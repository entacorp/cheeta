...
import static io.cheeta.server.search.code.FieldConstants.BLOB_PRIMARY_SYMBOLS;
import static io.cheeta.server.search.code.FieldConstants.BLOB_SECONDARY_SYMBOLS;
...
import static io.cheeta.server.search.code.FieldConstants.COMMIT_HASH;
import static io.cheeta.server.search.code.FieldConstants.COMMIT_INDEX_VERSION;
import static io.cheeta.server.search.code.FieldConstants.LAST_COMMIT;
import static io.cheeta.server.search.code.FieldConstants.LAST_COMMIT_HASH;
import static io.cheeta.server.search.code.FieldConstants.LAST_COMMIT_INDEX_VERSION;
import static io.cheeta.server.search.code.FieldConstants.META;
import static io.cheeta.server.search.code.IndexConstants.MAX_INDEXABLE_BLOB_SIZE;
...
import io.cheeta.server.util.IndexResult;
