...
public class MergePullRequest extends PullRequestActivity {

    private final Long requestId;

    public MergePullRequest(Date date, PullRequest pullRequest) {
        super(date);
    ...
    public Component render(String id) {
        ...
        var label = MessageFormat.format(_T("Merged pull request \"{0}\" ({1})"), "<a href=\"" + url + "\">" + request.getReference() + "</a>", HtmlEscape.escapeHtml5(request.getTitle()));
