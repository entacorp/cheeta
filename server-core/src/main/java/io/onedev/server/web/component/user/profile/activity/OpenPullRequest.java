...
public class OpenPullRequest extends PullRequestActivity {

    private final Long requestId;

    public OpenPullRequest(PullRequest pullRequest) {
        super(pullRequest.getSubmitDate());
    ...
    public Component render(String id) {
        ...
        var label = MessageFormat.format(_T("Opened pull request \"{0}\" ({1})"), "<a href=\"" + url + "\">" + request.getReference() + "</a>", HtmlEscape.escapeHtml5(request.getTitle()));
