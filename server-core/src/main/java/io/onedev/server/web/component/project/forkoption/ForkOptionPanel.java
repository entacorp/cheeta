package io.cheeta.server.web.component.project.forkoption;
				...
				try {
					...
					if (editor.isValid()) {
						...
						Cheeta.getInstance(TransactionService.class).run(() -> {
							...
							Cheeta.getInstance(AuditService.class).audit(newProject, "created project", null, VersionedXmlDoc.fromBean(auditData).toXML());
						});
