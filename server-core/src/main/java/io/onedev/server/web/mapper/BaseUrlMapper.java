...
import io.cheeta.server.web.page.admin.buildsetting.agent.AgentBuildsPage;
import io.cheeta.server.web.page.admin.buildsetting.agent.AgentListPage;
import io.cheeta.server.web.page.admin.buildsetting.agent.AgentLogPage;
import io.cheeta.server.web.page.admin.buildsetting.agent.AgentOverviewPage;
...
import io.cheeta.server.web.page.admin.ssosetting.NewSsoProviderPage;
import io.cheeta.server.web.page.admin.ssosetting.SsoProviderDetailPage;
...
import io.cheeta.server.web.page.error.PageNotFoundErrorPage;
import io.cheeta.server.web.page.help.IncompatibilitiesPage;
import io.cheeta.server.web.page.help.MethodDetailPage;
import io.cheeta.server.web.page.help.ResourceDetailPage;
import io.cheeta.server.web.page.help.ResourceListPage;
import io.cheeta.server.web.page.issues.IssueListPage;
...
import io.cheeta.server.web.page.packs.PackListPage;
import io.cheeta.server.web.page.project.NewProjectPage;
import io.cheeta.server.web.page.project.NoProjectStoragePage;
...
import io.cheeta.server.web.page.project.codecomments.InvalidCodeCommentPage;
...
import io.cheeta.server.web.page.project.issues.detail.IssueAuthorizationsPage;
import io.cheeta.server.web.page.project.issues.detail.IssueBuildsPage;
import io.cheeta.server.web.page.project.issues.detail.IssueCommitsPage;
import io.cheeta.server.web.page.project.issues.detail.IssueDetailPage;
import io.cheeta.server.web.page.project.issues.detail.IssuePullRequestsPage;
...
import io.cheeta.server.web.page.pullrequests.PullRequestListPage;
import io.cheeta.server.web.page.security.CreateUserFromInvitationPage;
import io.cheeta.server.web.page.security.EmailAddressVerificationPage;
...
import io.cheeta.server.web.page.security.PasswordResetPage;
import io.cheeta.server.web.page.security.SignUpPage;
import io.cheeta.server.web.page.security.SsoProcessPage;
import io.cheeta.server.web.page.serverinit.ServerInitPage;
import io.cheeta.server.web.page.test.TestPage;
...
import io.cheeta.server.web.resource.AgentLibResourceReference;
import io.cheeta.server.web.resource.AgentLogResourceReference;
import io.cheeta.server.web.resource.AgentResourceReference;
...
import io.cheeta.server.web.resource.BuildLogResourceReference;
...
import io.cheeta.server.web.resource.SiteFileResourceReference;
...
public class BaseUrlMapper extends CompoundRequestMapper {
	...
	private void addUserPages() {
		...
		add(new BasePageMapper("~users/${user}/authorizations", 
				io.cheeta.server.web.page.user.authorization.UserAuthorizationsPage.class));
	...
	private void addAdministrationPages() {
		...
		add(new BasePageMapper("~administration/settings/service-desk-setting", 
				io.cheeta.server.web.page.admin.servicedesk.ServiceDeskSettingPage.class));
	...
	private void addProjectPages() {
		...
		add(new ProjectPageMapper("${project}/~settings/user-authorizations", io.cheeta.server.web.page.project.setting.authorization.UserAuthorizationsPage.class));
		add(new ProjectPageMapper("${project}/~settings/group-authorizations", io.cheeta.server.web.page.project.setting.authorization.GroupAuthorizationsPage.class));
