package io.cheeta.server.web.page.admin.securitysetting;
...
public class SecuritySettingPage extends AdministrationPage {
	...
	protected void onInitialize() {
		...
		SecuritySetting securitySetting = Cheeta.getInstance(SettingService.class).getSecuritySetting();
		...
		Form<?> form = new Form<Void>("form") {
			...
			protected void onSubmit() {
				super.onSubmit();
				Cheeta.getInstance(SettingService.class).saveSecuritySetting(securitySetting);
