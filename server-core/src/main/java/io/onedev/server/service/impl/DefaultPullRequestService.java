...
import static io.cheeta.server.model.PullRequest.PROP_CLOSE_DATE;
import static io.cheeta.server.model.PullRequest.PROP_CLOSE_TIME_GROUPS;
import static io.cheeta.server.model.PullRequest.PROP_DURATION;
...
import static io.cheeta.server.model.PullRequest.PROP_SUBMIT_TIME_GROUPS;
import static io.cheeta.server.model.PullRequest.getSerialLockName;
import static io.cheeta.server.model.PullRequest.Status.MERGED;
import static io.cheeta.server.model.PullRequest.Status.OPEN;
...
import io.cheeta.server.event.project.pullrequest.PullRequestBuildCommitUpdated;
import io.cheeta.server.event.project.pullrequest.PullRequestBuildEvent;
import io.cheeta.server.event.project.pullrequest.PullRequestChanged;
import io.cheeta.server.event.project.pullrequest.PullRequestCheckFailed;
import io.cheeta.server.event.project.pullrequest.PullRequestCodeCommentEvent;
import io.cheeta.server.event.project.pullrequest.PullRequestDeleted;
import io.cheeta.server.event.project.pullrequest.PullRequestEvent;
import io.cheeta.server.event.project.pullrequest.PullRequestMergePreviewUpdated;
...
import io.cheeta.server.event.project.pullrequest.PullRequestsDeleted;
...
import io.cheeta.server.model.support.code.FileProtection;
...
import io.cheeta.server.model.support.pullrequest.changedata.PullRequestSourceBranchDeleteData;
import io.cheeta.server.model.support.pullrequest.changedata.PullRequestSourceBranchRestoreData;
import io.cheeta.server.model.support.pullrequest.changedata.PullRequestTargetBranchChangeData;
import io.cheeta.server.persistence.SequenceGenerator;
