...
public class JobLogEntryEx implements Serializable {
	...
	public static JobLogEntryEx parse(String text, StyleBuilder styleBuilder) {
        ...
        Function<String, Void> textAppender = new Function<>() {
		...
		BiFunction<Character, String, Void> actionPerformer = new BiFunction<>() {
					...
					case 'm':
						...
						for (int i = 0; i < fields.size(); i++) {
							...
							if (field.equals("0") || field.equals("")) {
								...
								styleBuilder.setBackgroundColor(Style.BACKGROUND_COLOR_DEFAULT);
