...
> **NOTE: ** We develop Cheeta at <a href="https://code.cheeta.io">code.cheeta.io</a> for sake of dogfooding. Please submit issues and pull requests there
...
<h2>
<a href="https://docs.cheeta.io">Get Started</a> 
</h2>
...
[**Try It**](https://code.cheeta.io/demo/dotnet-runtime)
...
[**Tutorial**](https://docs.cheeta.io/tutorials/cicd/dependency-update)
...
[**Demo**](https://code.cheeta.io/demo/react/~files/6039030814aedeaa6ebac706c0886e3675160666/packages/react-dom/src/client/ReactDOMSelect.js?position=source-202.1-202.36-1)
...
[**Tutorial**](https://docs.cheeta.io/tutorials/code/pullrequest-approval)
...
[**See It In Action**](https://code.cheeta.io/cheeta/server/~boards/State?iteration=4.2.0&backlog=true)
...
[**Tutorial**](https://docs.cheeta.io/tutorials/issue/state-auto-transition)
...
[**Tutorial**](https://docs.cheeta.io/tutorials/issue/service-desk)
...
[**Tutorial**](https://docs.cheeta.io/tutorials/issue/time-tracking)
...
[**Tutorial**](https://docs.cheeta.io/category/cicd)
...
[**Example1**](https://docs.cheeta.io/tutorials/cicd/agent-farm)
[**Example2**](https://docs.cheeta.io/tutorials/cicd/k8s-farm)
...
[**Tutorial1**](https://docs.cheeta.io/tutorials/cicd/diagnose-with-web-terminal)
[**Tutorial2**](https://docs.cheeta.io/tutorials/cicd/run-job-against-local-change)
...
CI/CD jobs.
[**Tutorial**](https://docs.cheeta.io/category/packages)
...
[**Example1**](https://code.cheeta.io/cheeta/server/~builds/4799/fixed-issues?query=%22State%22+is+%22Released%22+order+by+%22Priority%22+desc+and+%22Type%22+asc)
[**Example2**](https://code.cheeta.io/cheeta/server/~issues/1794/builds)
...
[**See It In Action**](https://code.cheeta.io/~projects?query=%22Path%22+is+%22cheeta%22)
...
[**Try It**](https://code.cheeta.io/cheeta/server/~issues)

![issue query](./doc/images/issue-query.gif)

## 🤖 MCP server to interact with Cheeta via AI agents
...
[**Tutorial**](https://docs.cheeta.io/tutorials/misc/working-with-mcp)
...
for everyone.
[**See It In Action**](https://code.cheeta.io/~dashboards)
...
[**More Info**](https://docs.cheeta.io/administration-guide/high-availabilty-scalabilty)
...
[**See It In Action**](https://code.cheeta.io/cheeta/server/~stats/lines)
...
[**Performance Comparison**](https://faun.pub/performance-compasion-of-cheeta-and-gitlab-c11fc27b25be#:~:text=Git%20Push%3A%20Cheeta%20is%2040,50%25%20less%20memory%20than%20GitLab)
